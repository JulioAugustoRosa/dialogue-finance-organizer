    ...
    <div className="min-h-screen bg-background flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 bg-primary items-center justify-center p-12">
        <div className="max-w-md text-primary-foreground">
          <h2 className="text-4xl font-bold mb-4">FinançasAI</h2>
          <p className="text-lg text-primary-foreground/80">
            Controle financeiro inteligente com IA. Gerencie receitas, despesas, metas e impostos de forma simples.
          </p>
        </div>
      </div>
      ...
      <div className="flex-1 flex items-center justify-center p-6">
        <div className="w-full max-w-md">
          ...
          <h1 className="text-2xl font-bold text-foreground mb-1">
            ...
            {tab === "signup" && "Crie sua conta"}
            {tab === "forgot" && "Recuperar senha"}
          </h1>
          <p className="text-muted-foreground mb-8">
            {tab === "login" && "Entre na sua conta para continuar."}
            {tab === "signup" && "Comece a organizar suas finanças."}
            {tab === "forgot" && "Enviaremos um link para redefinir sua senha."}
          </p>

          {tab !== "forgot" && (
            <button
              onClick={handleGoogleLogin}
              className="w-full flex items-center justify-center gap-3 px-4 py-2.5 rounded-lg border border-border text-foreground hover:bg-muted transition-colors mb-6"
            >
          ...
          <form onSubmit={tab === "login" ? handleLogin : tab === "signup" ? handleSignup : handleForgotPassword} className="space-y-4">
            {tab === "signup" && (
            ...
            {tab === "login" && (
              <button type="button" onClick={() => setTab("forgot")} className="text-sm text-primary hover:underline">
                Esqueci minha senha
              </button>
            )}
